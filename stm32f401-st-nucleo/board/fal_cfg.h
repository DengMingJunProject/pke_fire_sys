...
{                                                                                          \
	{FAL_PART_MAGIC_WROD,   "config",    "onchip_flash",    384 * 1024,   128 * 1024, 0}, \
    {FAL_PART_MAGIC_WORD, "download", 	NOR_FLASH_DEV_NAME,          0,    1024*1024, 0}, \
    {FAL_PART_MAGIC_WORD, "df_area",   NOR_FLASH_DEV_NAME,   1024*1024,    1024*1024, 0}, \
    {FAL_PART_MAGIC_WORD, "easyflash",  NOR_FLASH_DEV_NAME, 2*1024*1024,  1*1024*1024, 0}, \
    {FAL_PART_MAGIC_WORD, "filesystem", NOR_FLASH_DEV_NAME, 3*1024*1024, 13*1024*1024, 0}, \
}
