...
#define GPIOA_IDR_Addr    (GPIOA_BASE+18) //0x40010808 
#define GPIOB_IDR_Addr    (GPIOB_BASE+18) //0x40010C08 
#define GPIOC_IDR_Addr    (GPIOC_BASE+18) //0x40011008 
#define GPIOD_IDR_Addr    (GPIOD_BASE+18) //0x40011408 
#define GPIOE_IDR_Addr    (GPIOE_BASE+18) //0x40011808 
#define GPIOF_IDR_Addr    (GPIOF_BASE+18) //0x40011A08 
#define GPIOG_IDR_Addr    (GPIOG_BASE+18) //0x40011E08 
